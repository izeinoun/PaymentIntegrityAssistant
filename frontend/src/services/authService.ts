...
export async function logout(): Promise<void> {
  ...
  try {
    console.log('[AuthService] Making logout request to', `${API_BASE_URL}/api/auth/logout`)
    ...
    console.log('[AuthService] Logout response:', res.status, res.statusText)
    if (!res.ok) {
  ...
  // Broadcast to other tabs/apps
  console.log('[AuthService] Broadcasting auth:logout')
